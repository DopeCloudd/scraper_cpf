...
REM Log startup
echo [%DATE% %TIME%] Démarrage synchronisation open data CPF >> log.txt

REM Run the sync process and append output to the log
"%NODE_PATH%\npm.cmd" run sync:opendata >> log.txt 2>&1
